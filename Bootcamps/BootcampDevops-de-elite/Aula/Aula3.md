...
E claro que isso é usando o digitalocean... Não é usando outros providers, precisa-se ir na documentação do provider que está sendo usado no terraform e ver o que é necessário para pegar o provider... Além disso, vale lembrar onde estamos no processo de devops, estamos criando o hambiente de deploy usando terraform, checa o mapa da [Aula2](Bootcamps/BootcampDevops-de-elite/Aula/Aula2.md) para ficar bem por dentro, portanto, agora iremos fazer dentro da maquina virtual da núvem do provider, um cluster e dessa vez, utilizaremos o terraform :) O que acaba quase que ocmpletamente com  a aula 2 kakkakakkakak
