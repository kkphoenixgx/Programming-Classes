...
Agora vamos usar a nossa guard, para isso, utilizaremos uma tag a com um [`routerLink` da  aula 23](JavascriptTypescript/Angular/v16/Section%2012/Aula23.md), e um `queryParams`, que define parâmetros para serem resgatados pela URL,
...
[Use o exemplo da aula anterior](JavascriptTypescript/Angular/v16/section15/Aula39.md#Por%20referência,%20dos%20códigos) para entender os parâmetros `state` e `raute` , e então assim, entender o resgate, veja o retorno de `route` de um exemplo a parte:
