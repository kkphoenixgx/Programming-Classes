...
![](Pasted%20image%2020230611102821.png)
...
Como o usual, não tem como lidar com services sem utilizar o módulo de http do angular, se não tem uma boa base, dá uma checada na [Aula 27](JavascriptTypescript/Angular/v16/Section13/Aula27.md), dessa forma, faz o procedimento padrão e faz um inject...
...
Vamos fazer as seguintes modificações nos lugares específicos, dessa vez seguindo somente [-- Sobre a estrutura base --](JavascriptTypescript/Angular/v16/section14/Aula29.md#Aula%2029#--%20Sobre%20a%20estrutura%20base%20--)
