...
| Note           | commands                                                                                                         |
| -------------- | ---------------------------------------------------------------------------------------------------------------- |
| [[Images]]     | `docker run <image>`, `docker build <image path>`, dockerfile: `FROM`, `COPY`, `RUN`, `WORKDIR`, `CMD`, `EXPOSE` |
| [[Containers]] | `docker run <imageId>`, `docker ps`, `docker stop <containerName>`                                               |
